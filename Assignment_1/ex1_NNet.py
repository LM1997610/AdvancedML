...
print(''' 
  _ _______________________________________________________ _ _ _      
    ____     __                            __     _   
   |___ \   / /  __ _ _   _  ___ _ __   /\ \ \___| |_ 
     __) | / /  / _` | | | |/ _ \ '__| /  \/ / _ \ __|  ()
    / ___ / /__| (_| | |_| |  __/ |   / /\  /  __/ |_ 
   |_____|\____/\__,_|\__, |\___|_|   \_\ \/ \___|\__|  ()
                       |___/
      ''')
...
correct_scores = np.asarray([[0.36446210, 0.22911264, 0.40642526],
...
print(correct_scores); print()

# The difference should be very small. We get < 1e-7
print(f'Difference between your scores and correct scores: {np.sum(np.abs(scores - correct_scores))} \n')
...
print(f"My_loss: {round(loss, 7)}, correct_loss: {correct_loss}")
# should be very small, we get < 1e-12
print(f'Difference between your loss and correct loss: {np.sum(np.abs(loss - correct_loss))} \n')
...
print('Final training loss: ', round(stats['loss_history'][-1], 5))
...
print("""
_ _____________________________________________________________________________ _ _ _
  ___  ____  ____  __    ____        __  ___     ____    __   ____   __       
 / __)(_  _)( ___)/__\  (  _ \ ___  /  )/ _ \   (  _ \  /__\ (_  _) /__\   ()
( (__  _)(_  )__)/(__)\  )   /(___)  )(( (_) )   )(_) )/(__)\  )(  /(__)\     
 \___)(____)(__)(__)(__)(_)\_)      (__)\___/   (____/(__)(__)(__)(__)(__) () """)
...
print('Test labels shape: ', y_test.shape); print("")
...
h_diz = {"learning rate": 1e-4,
         "regularization": 0.25,
         "numer of epochs": 1000,
         "batch_size": 200}

print(f"Starting Hyper-parameters: \n   {h_diz}\n")
...
hyperp_diz = {"hidden_size" : 150,
              "learning_rate" : 0.004,
              "regularization" : 0.15,
              "numer of epochs" : 4000,
              "batch_size" : 450, "verbose" : False}

best_net = TwoLayerNet(input_size, hyperp_diz["hidden_size"], num_classes)

print()
print("...Tuning Hyper-parameters: \n")

for k,v in hyperp_diz.items():
  print(f"  '{k}': {v}")

print()

# Train the network
my_stats = best_net.train(X_train, y_train, X_val, y_val,
                          num_iters = hyperp_diz["numer of epochs"], 
                          batch_size = hyperp_diz["batch_size"],
                          learning_rate = hyperp_diz["learning_rate"], 
                          reg = hyperp_diz["regularization"], 
                          learning_rate_decay = 0.95,
                          verbose = hyperp_diz["verbose"])
